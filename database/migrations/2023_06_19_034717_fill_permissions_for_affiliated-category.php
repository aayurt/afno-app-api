...
class FillPermissionsForAffiliatedCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAffiliatedCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.affiliated-category',
            'admin.affiliated-category.index',
            'admin.affiliated-category.create',
            'admin.affiliated-category.show',
            'admin.affiliated-category.edit',
            'admin.affiliated-category.delete',
            'admin.affiliated-category.bulk-delete',
        ]);
