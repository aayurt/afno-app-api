...
class FillPermissionsForSubActivity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSubActivity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sub-activity',
            'admin.sub-activity.index',
            'admin.sub-activity.create',
            'admin.sub-activity.show',
            'admin.sub-activity.edit',
            'admin.sub-activity.delete',
            'admin.sub-activity.bulk-delete',
        ]);
