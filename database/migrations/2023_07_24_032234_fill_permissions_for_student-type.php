...
class FillPermissionsForStudentType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStudentType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.student-type',
            'admin.student-type.index',
            'admin.student-type.create',
            'admin.student-type.show',
            'admin.student-type.edit',
            'admin.student-type.delete',
            'admin.student-type.bulk-delete',
        ]);
