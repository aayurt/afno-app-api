...
class FillPermissionsForJoinLeaveStudentHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForJoinLeaveStudentHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.join-leave-student-history',
            'admin.join-leave-student-history.index',
            'admin.join-leave-student-history.create',
            'admin.join-leave-student-history.show',
            'admin.join-leave-student-history.edit',
            'admin.join-leave-student-history.delete',
            'admin.join-leave-student-history.bulk-delete',
        ]);
