...
class FillPermissionsForMemberCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMemberCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.member-category',
            'admin.member-category.index',
            'admin.member-category.create',
            'admin.member-category.show',
            'admin.member-category.edit',
            'admin.member-category.delete',
            'admin.member-category.bulk-delete',
        ]);
