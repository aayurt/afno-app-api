...
class FillPermissionsForJoinLeaveMemberHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForJoinLeaveMemberHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.join-leave-member-history',
            'admin.join-leave-member-history.index',
            'admin.join-leave-member-history.create',
            'admin.join-leave-member-history.show',
            'admin.join-leave-member-history.edit',
            'admin.join-leave-member-history.delete',
            'admin.join-leave-member-history.bulk-delete',
        ]);
