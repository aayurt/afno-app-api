...
class FillPermissionsForAffiliatedGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAffiliatedGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.affiliated-group',
            'admin.affiliated-group.index',
            'admin.affiliated-group.create',
            'admin.affiliated-group.show',
            'admin.affiliated-group.edit',
            'admin.affiliated-group.delete',
            'admin.affiliated-group.bulk-delete',
        ]);
