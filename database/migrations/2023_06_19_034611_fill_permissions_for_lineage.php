...
class FillPermissionsForLineage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLineage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lineage',
            'admin.lineage.index',
            'admin.lineage.create',
            'admin.lineage.show',
            'admin.lineage.edit',
            'admin.lineage.delete',
            'admin.lineage.bulk-delete',
        ]);
