...
class FillPermissionsForMemberAttendance extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMemberAttendance constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.member-attendance.index',
            'admin.member-attendance.create',
            'admin.member-attendance.show',
            'admin.member-attendance.edit',
            'admin.member-attendance.delete',
            'admin.member-attendance.bulk-delete',
        ]);
