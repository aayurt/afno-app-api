...
class FillPermissionsForFoodItemTag extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFoodItemTag constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.food-item-tag',
            'admin.food-item-tag.index',
            'admin.food-item-tag.create',
            'admin.food-item-tag.show',
            'admin.food-item-tag.edit',
            'admin.food-item-tag.delete',
            'admin.food-item-tag.bulk-delete',
        ]);
