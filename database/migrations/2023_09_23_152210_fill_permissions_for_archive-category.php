...
class FillPermissionsForArchiveCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForArchiveCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.archive-category.index',
            'admin.archive-category.create',
            'admin.archive-category.show',
            'admin.archive-category.edit',
            'admin.archive-category.delete',
            'admin.archive-category.bulk-delete',
        ]);
