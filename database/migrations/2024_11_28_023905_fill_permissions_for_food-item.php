...
class FillPermissionsForFoodItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFoodItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.food-item',
            'admin.food-item.index',
            'admin.food-item.create',
            'admin.food-item.show',
            'admin.food-item.edit',
            'admin.food-item.delete',
            'admin.food-item.bulk-delete',
        ]);
