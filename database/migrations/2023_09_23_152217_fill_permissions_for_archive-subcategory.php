...
class FillPermissionsForArchiveSubcategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForArchiveSubcategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.archive-subcategory',
            'admin.archive-subcategory.index',
            'admin.archive-subcategory.create',
            'admin.archive-subcategory.show',
            'admin.archive-subcategory.edit',
            'admin.archive-subcategory.delete',
            'admin.archive-subcategory.bulk-delete',
        ]);
