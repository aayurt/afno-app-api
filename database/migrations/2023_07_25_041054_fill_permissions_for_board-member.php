...
class FillPermissionsForBoardMember extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBoardMember constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.board-member',
            'admin.board-member.index',
            'admin.board-member.create',
            'admin.board-member.show',
            'admin.board-member.edit',
            'admin.board-member.delete',
            'admin.board-member.bulk-delete',
        ]);
