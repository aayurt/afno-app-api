...
<post-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/posts') }}'" :trans="{{ json_encode(trans('brackets/admin-ui::admin.dialogs')) }}" inline-template>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm pull-right m-b-0 ml-2" href="{{ url('admin/posts/export') }}" role="button"><i class="fa fa-file-excel-o"></i>&nbsp; {{ trans('admin.post.actions.export') }}</a>
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'popularity'">{{ trans('admin.post.columns.popularity') }}</th>
                                    <th is='sortable' :column="'category_id'">{{ trans('admin.post.columns.category_id') }}</th>
                                    <th is='sortable' :column="'author_id'">{{ trans('admin.post.columns.author_id') }}</th>
                                    <th is='sortable' :column="'tags_id'">{{ trans('admin.post.columns.tags_id') }}</th>
