...
@section('title', trans('admin.activity.actions.edit', ['name' => $activity->title]))
...
v-cloak inline-template> <form class="form-horizontal form-edit" method="post" @submit.prevent="onSubmit"
    ...
    <div class="col">
        <div class="card">
            ...
            <i class="fa fa-pencil"></i> {{ trans('admin.activity.actions.edit', ['name' => $activity->title]) }}
            </div>
            ...
            <div class="col-md-12 col-lg-12 col-xl-3 col-xxl-4">
                @include('admin.activity.components.form-elements-right', ['showHistory' => true])
            </div>
