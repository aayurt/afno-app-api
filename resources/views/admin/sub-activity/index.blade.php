...
@section('title', trans('admin.sub-activity.actions.index'))

@section('body')

    <sub-activity-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/sub-activities') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.sub-activity.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/sub-activities/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.sub-activity.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                                    ...
                                    <tr v-show="(clickedBulkItemsCount > 0) || isClickedAll">
                                        <td class="bg-bulk-info d-table-cell text-center" colspan="8">
                                            ...
                                            <span class="pull-right pr-2">
                                                <button class="btn btn-sm btn-danger pr-3 pl-3" @click="bulkDelete('/admin/sub-activities/bulk-destroy')">{{ trans('brackets/admin-ui::admin.btn.delete') }}</button>
                                            </span>
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/sub-activities/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.sub-activity.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
