...
<div class="container-xl">
    ...
    <div class="card">
        ...
        <sub-category-form :action="'{{ url('admin/sub-categories') }}'" :locales="{{ json_encode($locales) }}" :categories="{{$categories->toJson()}}" :send-empty-locales="false" v-cloak inline-template>
