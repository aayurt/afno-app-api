...
<restaurant-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/restaurants') }}'" inline-template>
                ...
                <div class="card-body" v-cloak>
                    <div class="card-block">
                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'title'">{{ trans('admin.restaurant.columns.title') }}
                                    </th>
                                    <th is='sortable' :column="'enabled'">{{ trans('admin.restaurant.columns.enabled')
                                        }}</th>
                                    ...
                                    <td class="bg-bulk-info d-table-cell text-center" colspan="27">
                                        <span class="align-middle font-weight-light text-dark">{{
                                            ...
                                            clickedBulkItemsCount }}. <a href="#" class="text-primary"
                                                @click="onBulkItemsClickedAll('/admin/restaurants')"
                                        ...
                                        <span class="pull-right pr-2">
                                            <button class="btn btn-sm btn-danger pr-3 pl-3"
                                                @click="bulkDelete('/admin/restaurants/bulk-destroy')">{{
                        ...
                        <div class="no-items-found" v-if="!collection.length > 0">
                            ...
                            <a class="btn btn-primary btn-spinner" href="{{ url('admin/restaurants/create') }}"
