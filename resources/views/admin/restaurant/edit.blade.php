...
@section('title', trans('admin.restaurant.actions.edit', ['name' => $restaurant->title]))

@section('body')

<div class="container-xl">

    <restaurant-form  :action="'{{ $restaurant->resource_url }}'"
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-pencil"></i> {{ trans('admin.restaurant.actions.edit', ['name' => $restaurant->title]) }}
                        </div>

                        <div class="card-body">
                            @include('admin.restaurant.components.form-elements')
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-12 col-xl-3 col-xxl-4">
                    @include('admin.restaurant.components.form-elements-right', ['showHistory' => true])
                </div>
            </div>
