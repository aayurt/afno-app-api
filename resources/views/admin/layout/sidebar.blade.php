<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
           ...
           <li class="nav-item border-bottom mb-1"><a class="nav-link" href="{{ url('admin/join-leave-student-histories') }}"><i class="nav-icon icon-star"></i> {{ trans('admin.join-leave-student-history.title') }}</a></li>
